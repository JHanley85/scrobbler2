...
== Albums
  ...
  album = Scrobbler2::Album.new(:artist=>'Carrie Underwood', :album=>'Some Hearts')
...
== Artists
  ...
  artist = Scrobbler2::Artist.new(:artist=>'Carrie Underwood')
...
== Tags	
  ...
  tag = Scrobbler2::Tag.new(:tag=>'country')
...
== Tracks
  ...
  track = Scrobbler2::Track.new(:artist=>'Carrie Underwood', :track=>'Before He Cheats')
  puts 'Fans'
  puts "=" * 4
